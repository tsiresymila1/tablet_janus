...
class VideoCallDefault extends StatefulWidget {
  const VideoCallDefault({super.key});
  @override
  State<VideoCallDefault> createState() => _VideoCallDefault();
}

class _VideoCallDefault extends State<VideoCallDefault> {
  late JanusClient j;
  ...
  initJanusClient() async {
    ...
    publishVideo.remoteTrack?.listen((event) async {
      if (event.track != null && event.flowing == true) {
        logInfo("Remote track avalaible .....");
